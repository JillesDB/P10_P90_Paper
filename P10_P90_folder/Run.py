...
folder_path = r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\P10_P90_folder\Forecasts'  # Change this to the path of your CSV files

#
# def rename_files(folder_path):
#     for filename in os.listdir(folder_path):
#         if filename.endswith('.csv'):
#             new_filename = filename.replace('dataframe', 'df')
...
Generate_Evaluate_and_Time_Forecast_P10_P90.Predict_Evaluate_and_Time(path_real_prices=real_prices_path
,path_forecasts_folder = os.path.join(cwd, 'Forecasts')
,dataset_train='Dataset',dataset_test='Dataset_P90_Windsolar_Reg_Load',path_datasets_folder=datasets_path
,begin_test_date='2020-01-01', end_test_date='2022-12-31',recalibration_window=1,calibration_window_set={56,84,112,714,721,728},
regular=1,weighed=1)
...
,dataset_train='Dataset',dataset_test='Dataset_P10_Windsolar_P90_Load',path_datasets_folder=datasets_path
,begin_test_date='2020-01-01', end_test_date='2022-12-31',recalibration_window=1,calibration_window_set={56,84,112,714,721,728},
regular=1,weighed=1)

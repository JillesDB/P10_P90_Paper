...
def create_ensemble_forecast(dataset_train,dataset_test,path_real_prices,path_datasets_folder,path_forecasts_folder=None,
    ...
    for cw in calibration_window_set:
        name_csv_file = 'LEAR_train_df_' + str(dataset_train) +'_test_df_' + str(dataset_test) + \
    ...
    print(timing)
    if weighed == 1:
        Weighted_Ensemble_file_name = 'Weighted_Ensemble_LEAR_train_df_' + str(dataset_train) +'_test_df_' + str(dataset_test) + \
    ...
    if regular ==1:
        Ensemble_file_name = 'Ensemble_LEAR_train_df_' + str(dataset_train) +'_test_df_' + str(dataset_test) + \
                         '_RW' + str(recalibration_window) + '.csv'
